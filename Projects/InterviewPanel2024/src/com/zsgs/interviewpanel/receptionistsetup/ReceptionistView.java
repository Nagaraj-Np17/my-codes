package com.zsgs.interviewpanel.receptionistsetup;

import java.util.Scanner;

import com.zsgs.interviewpanel.datalayer.InterviewPannelDatabase;
import com.zsgs.interviewpanel.login.LoginView;
import com.zsgs.interviewpanel.manageinterview.ManageIntervieweeView;
...
public class ReceptionistView {
	 private ReceptionistModel receptionistModel;
	    ...
	    private void signUp() {
	        ...
	        System.out.println("Enter the receptionist phone :");
	        String phone = scanner.nextLine();
	        System.out.println("Enter the receptionist email id :");
	        String emailId = scanner.nextLine();
	        System.out.println("Enter the receptionist location :");
	        String address = scanner.nextLine();
	        Receptionist recep = new Receptionist(userName, passWord, phone, emailId, address);
	        receptionistModel.signUp(recep);
		}
