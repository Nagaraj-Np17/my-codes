...
public class ReceptionistModel {
	  private ReceptionistView receptionistView;
	    ...
	    public void addReceptionist(){
	        InterviewPannelDatabase.getInstance().addReceptionist(new Receptionist("recep", "recep@123", "9751590041", "selvaganesh7378@gmail.com", "sedapatti"));
	    }

		public void signUp(Receptionist recep) {
			InterviewPannelDatabase.getInstance().addReceptionist(recep);
			receptionistView.showMessage("Receptionist Created succesfully");
			receptionistView.mainMenu();
		}
